...
(function (e, t) {
  ...
  st.Animation = st.extend(P, {tweener: function (e, t) {
    ...
    this.elem = e, this.prop = n, this.easing = i || "swing", this.o = t, this.start = this.now = this.cur(), this.end = r, this.unit = o || (st.cssNumber[n] ? "" : "px")
  }, cur: function () {
    var e = $.propHooks[this.prop];
    return e && e.get ? e.get(this) : $.propHooks._default.get(this)
  }, run: function (e) {
    var t, n = $.propHooks[this.prop];
    return this.pos = t = this.o.duration ? st.easing[this.easing](e, this.o.duration * e, 0, 1, this.o.duration) : e, this.now = (this.end - this.start) * t + this.start, this.o.step && this.o.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : $.propHooks._default.set(this), this
